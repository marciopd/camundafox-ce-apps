...
wget http://fox.camunda.com/community/release/fox-platform/jboss7.1/1.30.0/fox-platform-ce-jboss-1.30.0.zip -P ~/camunda-fox-tests-env/appserver
echo '--------------------------------------'
echo '3 - Unzipping...'
unzip ~/camunda-fox-tests-env/appserver/fox-platform-ce-jboss-1.30.0.zip -d ~/camunda-fox-tests-env/appserver/
echo '--------------------------------------'
echo '3 - Running FOX CE application server'
sh ~/camunda-fox-tests-env/appserver/fox-platform-ce-jboss-1.30.0/server/jboss-as-7.1.0.Final/bin/standalone.sh
